...
describe("createExperiment — no uid (anonymous)", () => {
  test("skips folder creation entirely, doc saved without owner field", async () => {
    const r = await createExperiment("EID", "Exp", undefined, "googledrive");
