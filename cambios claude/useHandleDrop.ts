...
export default function handleDrop({
  ...
  // Divide by stageScale to convert screen pixels → canvas-space coordinates
  const x = (e.clientX - containerRect.left) / stageScale;
  const y = (e.clientY - containerRect.top) / stageScale;
