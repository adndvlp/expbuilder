...
test("runs generated local persistence through HTTP, LowDB and CSV", async () => {
  ...
  try {
    ...
    const evaluateConditionRuntimeCode = `
  ...
  `;
    ...
    const branchingEvaluationRuntimeCode = `
      ...
      await page.evaluate((code) => {
        Object.assign(window, {
          ...
          ExpBuilderNavigation: {
            consumeReloadMarker: () => ({ request: null, status: 'stalled' }),
            clearTransientState: () => undefined,
            isTransitionPending: () => false,
            onTrialPersisted: () => undefined,
            activateResume: () => undefined,
          },
          ExpBuilderBranching: {
            evaluateCondition: () => true,
            decide: () => ({ targetId: null, conditionId: null, usedDefault: true, customParameters: null }),
          },
          ExpBuilderRuntime: {
            emit: () => undefined,
