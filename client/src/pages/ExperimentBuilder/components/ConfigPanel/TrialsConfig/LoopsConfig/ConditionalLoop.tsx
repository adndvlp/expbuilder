...
function ConditionalLoop({ loop, onClose, onSave }: Props) {
  ...
  // Get available columns for a trial (for branching conditions)
                    ...
                    >
                      ...
                      <tbody>
                        {condition.rules.map((rule, ruleIdx) => {
                          ...
                          const availableColumns = selectedTrial
                            ? getAvailableColumns(selectedTrial)
                            : [];
                          ...
                          if (
                            ...
                            if (parts.length >= 2) {
                              ...
                              const components =
                                selectedTrial.columnMapping?.components
                                  ?.value || [];
